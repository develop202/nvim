  ...
  -- Set up nvim-jdtls to attach to java files.
  {
    ...
    config = function()
      ...
      local java_dependency_bundle = vim.split(
        vim.fn.glob(
          "/data/data/com.termux/files/home/.local/share/code-server/extensions/vscjava.vscode-java-dependency-0.23.6-universal/server/com.microsoft.jdtls.ext.core-*.jar"
        ),
        "\n"
      )
